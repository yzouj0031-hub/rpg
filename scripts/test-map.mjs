...
const storyPoints = {
  ...
  '日记·隔间': [16, 1], '日记·楼梯': [9, 11], '日记·谱架': [21, 6], '日记·档案架': [29, 10], '日记·水面': [17, 19],
  '躲藏·课桌': [3, 2], '躲藏·储物柜': [18, 6], '躲藏·值班室铁柜': [8, 15], '躲藏·档案台': [25, 13], '躲藏·演出服柜': [30, 1], '躲藏·配电间铁柜': [16, 15],
  '巡逻·音乐教室': [29, 2], '巡逻·连廊': [25, 8], '巡逻·地下通道': [16, 20]
};
